		...
		this._target.addClass('dotslide-container')
					...
					.append($('<div></div>').addClass('dotslide-component controls')
											.append($('<div></div>').addClass('dotslide-component reel-control')
																	.append($('<a></a>').addClass('dotslide-component control-button nav-begin').html('&#10218;'))
																	.append($('<a></a>').addClass('dotslide-component control-button nav-prev').html('&#10216;'))
																	.append($('<div></div>').addClass('dotslide-component reel-window')
																							.append($('<div></div>').addClass('dotslide-component reel')))
																	.append($('<a></a>').addClass('dotslide-component control-button nav-next').html('&#10217;'))
																	.append($('<a></a>').addClass('dotslide-component control-button nav-end').html('&#10219;')))
